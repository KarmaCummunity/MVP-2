...
| RESP-002 | **Wire shell into root** — mount `AppShell` in root `_layout.tsx`, flip `SHELL_V2_ENABLED` default (FR-RESP-002) | agent-fe | ⏳ Planned | `spec/14_responsive_desktop.md` FR-RESP-002 |
