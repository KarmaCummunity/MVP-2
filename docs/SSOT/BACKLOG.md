...
| P2.34 | **Surveys & feedback — in-app Survey A + free feedback (FR-SETTINGS-015..017)** — server-driven survey hub in Settings, survey runner (1–7 rating + optional text per question, non-linear navigation, snooze banner), free feedback form, migrations `0118_surveys` + `0119_user_feedback`. | agent-be + agent-fe | 🟡 In progress | `spec/11_settings.md` FR-SETTINGS-015..017 |
