...
│                                                             │
├─────────────────────────────────────────────────────────────┤
│  Bottom Tab:  [👤 Profile] [🔍 Search] [➕ Plus] [💝 Donations] [🏠 Home] │
└─────────────────────────────────────────────────────────────┘
```
...
[Auth Flow] ──→ [🏠 Home Feed] ──┬──→ [Post Detail] ──→ [Chat]
                  ...
                  │
                  ├──→ [🔍 Search Tab] ──→ [Placeholder → CTA back to Home]
                  │                       (Universal-search engine: P2)
                  │
                  ├──→ [➕ Create Post] ──→ [Home with new post]
                  │
                  ├──→ [💝 Donations Hub] ──┬──→ [🎁 Items → Home Feed]
                  │                         ├──→ [⏰ Time → External link to we-me.app]
                  │                         │              └──→ [Volunteer composer → local intent log + alert (TD-114)]
                  │                         └──→ [💰 Money → External link to jgive.com]
                  │
