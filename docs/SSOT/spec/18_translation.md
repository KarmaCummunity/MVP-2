...
**Related.** Migrations `0208_content_translations.sql` (Phase 1a) + `0209_content_translations_read.sql` (Phase 1c; Phase 1b adds no migration). Edge Function `supabase/functions/translate`. Phase 1c consumes `ITranslationService` on a cache miss via `MaterializePostTranslationsUseCase`. SQL regression: `supabase/tests/0209_content_translations_read.sql`.
