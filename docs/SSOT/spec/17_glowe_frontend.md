...
**Status.** ✅ Done — Phase 1 (chrome + home translated, full RTL). Deeper page-body translation is phased (see Out of scope).
...
**Out of scope (phased — see `TECH_DEBT.md` TD-175).**
- Full translation of the inner page bodies (Organizations, Community, Forums, Wishing Well, About, etc.) and of `data.js` seed content — these fall back to English until their strings are added to the dictionary in follow-up PRs.
