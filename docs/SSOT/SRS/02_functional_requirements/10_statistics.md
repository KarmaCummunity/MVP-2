...
- Aggregated cohort dashboards for product analytics — those live in the analytics pipeline (see [`06_cross_cutting/01_analytics_and_events.md`](../06_cross_cutting/01_analytics_and_events.md)) and are not user-facing.
