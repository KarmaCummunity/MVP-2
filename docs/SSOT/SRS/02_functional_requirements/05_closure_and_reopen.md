...
- AC3. Telemetry event `closure_step1_completed` fires upon confirmation (see [`06_cross_cutting/01_analytics_and_events.md`](../06_cross_cutting/01_analytics_and_events.md)).
...
**Acceptance Criteria.**
- AC1. `bg-job-soft-delete-cleanup` (see [`06_cross_cutting/05_background_jobs.md`](../06_cross_cutting/05_background_jobs.md)) runs daily.
