...
// In CI, fall back to the local Supabase stack started by `supabase start`.
...
const SERVICE_KEY =
  process.env['SUPABASE_SERVICE_ROLE_KEY'] ?? (process.env['CI'] ? LOCAL_DEFAULT_SERVICE_KEY : undefined);
