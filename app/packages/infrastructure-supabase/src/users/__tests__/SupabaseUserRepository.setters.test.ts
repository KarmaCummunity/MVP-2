...
describe('SupabaseUserRepository — direct UPDATE-on-users setters', () => {
  it.each([
    ...
    ['setPreferredLanguage (string)', (r: SupabaseUserRepository) => r.setPreferredLanguage('u_1', 'pt-BR'), { preferred_language: 'pt-BR' }],
    ['setPreferredLanguage (null)', (r: SupabaseUserRepository) => r.setPreferredLanguage('u_1', null), { preferred_language: null }],
  ...
  it.each([
    ...
    ['setPreferredLanguage', (r: SupabaseUserRepository) => r.setPreferredLanguage('u_1', 'en')],
