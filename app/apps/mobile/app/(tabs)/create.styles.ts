...
export const createPostStyles = StyleSheet.create({
  ...
  // Header floats on the cream backdrop — no bottom border, no white card,
  // matching the welcome-screen idiom where the screen-level chrome is invisible.
  header: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  typeToggle: {
    ...
    overflow: 'hidden',
    // Soft elevation so the toggle sits "above" the cream backdrop.
    shadowColor: '#000',
