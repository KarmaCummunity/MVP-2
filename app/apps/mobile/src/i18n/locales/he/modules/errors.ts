...
export const errorsHe = {
  ...
  post: {
    ...
    address_required:
      'יש להזין עיר, רחוב ומספר בית. מה שמוצג בפיד נקבע ב«תצוגת הכתובת» — ברירת המחדל: עיר ורחוב בלבד.',
    address_invalid: 'לא ניתן לפרסם את הפוסט. בדקו עיר, רחוב ומספר בית, או נסו שוב.',
    active_post_limit_exceeded: 'הגעת למקסימום 20 פוסטים פעילים. סגרו או מחקו פוסט קיים לפני פרסום חדש.',
    followers_only_requires_private:
      'פוסט לעוקבים בלבד דורש פרופיל פרטי. שנהו את הפרופיל לפרטי בהגדרות ← פרטיות.',
    ...
    not_found: 'הפוסט לא נמצא — ייתכן שהוא נמחק.',
  ...
  createPost: {
    ...
    missingCityBeforePublish: 'נא לבחור עיר לפני פרסום.',
    missingStreetBeforePublish:
      'נא למלא רחוב לפני פרסום. בפיד מוצגים בדרך כלל עיר ורחוב בלבד — רמת התצוגה נקבעת ב«הגדרות חשיפה».',
    missingStreetNumberBeforePublish:
      'נא למלא מספר בית לפני פרסום. בפיד מוצגים בדרך כלל עיר ורחוב בלבד — רמת התצוגה נקבעת ב«הגדרות חשיפה».',
    missingAddressPairBeforePublish:
      'נא למלא רחוב ומספר בית לפני פרסום. הכתובת המלאה נשמרת לצורך התאמה; מה שמוצג בפיד — בשליטתך ב«הגדרות חשיפה».',
  },
} as const;
